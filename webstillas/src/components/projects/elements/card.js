            ...
            <article className={"card"}>
                    ...
                    <div className={"information-highlights"}>
                        <ul className={"information-list"}>
                            <li className={"horizontal-list"}>
                                <div>
                                    <span className={"highlightText"}>NTNU Prosjekt</span>
                                </div>
                            ...
                            <li className={"horizontal-list"}>
                                <div>
                                    <span className={"highlightText"}>01.02.2020-02.02.2022</span>
                                </div>
                                <div className={"highlightText-caption"}>
                            ...
                            <li className={"horizontal-list"}>
                                <div>
                                    <span className={"highlightText"}>200</span>
                                    <span >&#13217;</span>
                                </div>
                                <div className={"highlightText-caption"}>
                                    <span>Størrelse</span>
                ...
                <section className={"card-btn"}>
                    <div className={"card-btns"}>
                        <button type={"button"}>Mer informasjon</button>
                    </div>
                </section>
            </article>
        </div>
